...
namespace ElementsLib.Elements.Config.Articles
{
    ...
    using SourceItem = Sources.TaxIncomesHealthSource;
    ...
    public class TaxIncomesHealthArticle : GeneralArticle, ICloneable
    {
        ...
        public static string ARTICLE_DESCRIPTION_ERROR_FORMAT = "TaxIncomesHealthArticle(ARTICLE_TAX_INCOMES_HEALTH, 1005): {0}";

        public TaxIncomesHealthArticle() : base((ConfigRole)ConfigRoleEnum.ARTICLE_TAX_INCOMES_HEALTH)
        {
            SourceValues = new TaxIncomesHealthSource();

            InternalEvaluate = TaxIncomesHealthConcept.EvaluateConcept;
        }

        public TaxIncomesHealthArticle(ISourceValues values) : this()
        {
            TaxIncomesHealthSource sourceValues = values as TaxIncomesHealthSource;

            SourceValues = CloneUtils<TaxIncomesHealthSource>.CloneOrNull(sourceValues);
        }
        ...
        public TaxIncomesHealthSource SourceValues { get; set; }
        ...
        {
            TaxIncomesHealthArticle cloneArticle = (TaxIncomesHealthArticle)this.MemberwiseClone();
