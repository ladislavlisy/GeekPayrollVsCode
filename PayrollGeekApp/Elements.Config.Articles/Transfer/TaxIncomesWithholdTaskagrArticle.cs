...
namespace ElementsLib.Elements.Config.Articles
{
    ...
    public class TaxIncomesWithholdTaskagrArticle : GeneralArticle, ICloneable
    {
        ...
        public TaxIncomesWithholdTaskagrArticle() : base((ConfigRole)ConfigRoleEnum.ARTICLE_TAX_INCOMES_WITHHOLD_TASKAGR)
        {
            ...
            InternalEvaluate = TaxIncomesWithholdTaskagrConcept.EvaluateConcept;
        }

        public TaxIncomesWithholdTaskagrArticle(ISourceValues values) : this()
        {
        ...
        public TaxIncomesWithholdSource SourceValues { get; set; }
        ...
        {
            TaxIncomesWithholdTaskagrArticle cloneArticle = (TaxIncomesWithholdTaskagrArticle)this.MemberwiseClone();
