...
namespace ElementsLib.Elements.Config.Articles
{
    ...
    using SourceItem = Sources.TaxBaseAdvanceSolidarySource;
    ...
    public class TaxBaseAdvanceSolidaryArticle : GeneralArticle, ICloneable
    {
        ...
        public static string ARTICLE_DESCRIPTION_ERROR_FORMAT = "TaxBaseSolidaryArticle(ARTICLE_TAX_BASE_ADVANCE_SOLIDARY, 1019): {0}";

        public TaxBaseAdvanceSolidaryArticle() : base((ConfigRole)ConfigRoleEnum.ARTICLE_TAX_BASE_ADVANCE_SOLIDARY)
        {
            SourceValues = new TaxBaseAdvanceSolidarySource();

            InternalEvaluate = TaxBaseAdvanceSolidaryConcept.EvaluateConcept;
        }

        public TaxBaseAdvanceSolidaryArticle(ISourceValues values) : this()
        {
            TaxBaseAdvanceSolidarySource sourceValues = values as TaxBaseAdvanceSolidarySource;

            SourceValues = CloneUtils<TaxBaseAdvanceSolidarySource>.CloneOrNull(sourceValues);
        }
        ...
        public TaxBaseAdvanceSolidarySource SourceValues { get; set; }

        public override void ImportSourceValues(ISourceValues values)
        {
            SourceValues = SetSourceValues<TaxBaseAdvanceSolidarySource>(values);
        }
        ...
        {
            TaxBaseAdvanceSolidaryArticle cloneArticle = (TaxBaseAdvanceSolidaryArticle)this.MemberwiseClone();
