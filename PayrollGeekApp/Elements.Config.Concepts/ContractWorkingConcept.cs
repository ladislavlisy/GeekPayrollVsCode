...
namespace ElementsLib.Elements.Config.Concepts
{
    ...
    using MasterItem = Articles.ContractWorkingArticle;
    ...
    {
        public static string CONCEPT_DESCRIPTION_ERROR_FORMAT = "ContractWorkingConcept(ARTICLE_CONTRACT_WORKING, 3): {0}";
