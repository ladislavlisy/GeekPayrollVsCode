...
namespace ElementsLib.Elements.Config.Concepts
{
    ...
    public static class TaxIncomesWithholdTaskagrConcept
    {
        public static string CONCEPT_DESCRIPTION_ERROR_FORMAT = "TaxIncomesWithholdTaskagrConcept(ARTICLE_TAX_INCOMES_WITHHOLD_TASKAGR, 1010): {0}";
